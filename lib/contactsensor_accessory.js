...
this.log.log(`Contact normalAsync ${hbValue}`);
    this.setCachedState(name, hbValue);
    if (this.isRefresh) {
this.log.log(`Contact refresh ${name} ${hbValue}`);
      this.service
        .getCharacteristic(name)
        .updateValue(hbValue);
    } else {
this.log.log(`Contact Cache ${name} ${hbValue}`);
  ...
  updateState(data) {
this.log.log('Contact update state');
